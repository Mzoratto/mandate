...
The workflow builds an amd64 single-manifest image, pushes it under the immutable commit SHA, requires the ECR scan to complete with zero critical findings, updates only `mandate-dashboard`, and verifies that the public origin still rejects unauthenticated requests. The scoped deployment and zero-critical-finding scan gate passed in [run 34813074224](https://github.com/Mzoratto/mandate/actions/runs/34813074224). [Run 34941966864](https://github.com/Mzoratto/mandate/actions/runs/34941966864) promoted merge commit `6e53069a2f67d0ac7439b26762088bc2f52ac116`, removing the unlicensed portrait raster and generating the production visualization solely from digest-recorded CC0 geometry, code-owned coloring, and MIT-licensed shader noise. [Run 34943694024](https://github.com/Mzoratto/mandate/actions/runs/34943694024) promoted merge commit `aa84f0841bb8b76a5e10b975e51482226d1810e9` with public privacy and terms records while preserving the simulator/dashboard authentication boundary. [Run 34948633495](https://github.com/Mzoratto/mandate/actions/runs/34948633495) promoted merge commit `54669b590f4475fe6e6186e02f7a7d610fba3e4b`, restoring mesh-derived facial definition without adding any raster or changing the CC0/MIT asset boundary. [Run 34963190128](https://github.com/Mzoratto/mandate/actions/runs/34963190128) promoted merge commit `29e32955473954db9d916f87e0c7251673bd94f9`, restoring the user-approved portrait after the project owner confirmed that its ChatGPT-generated reference was authorized for the public repository, hackathon submission, and video. The immutable image passed the zero-critical ECR scan gate and preserved all public and authenticated route boundaries; production serves the recorded raster digest `787fe9c9568f3c166679a8baa87abb559076ce0f40fe1a9f98947e87876e803d`.
