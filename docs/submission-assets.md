...
All screenshots are 1440 × 900 PNGs captured from `https://o2mjeuvaik.execute-api.us-east-1.amazonaws.com`. Portrait-bearing screenshots 1, 2, and 4 were recaptured after corrected-portrait deployment [34948633495](https://github.com/Mzoratto/mandate/actions/runs/34948633495); screenshot 3 is unchanged because the simulator does not render the portrait.
...
| `assets/screenshots/01-public-guided-simulation.png` | `d257573952bfbc7aab64efd29e9b390a26b0e1255103fd260c6da072478f9cfe` |
| `assets/screenshots/02-boundary-denial.png` | `6e9f7695e09884b2d9f9e7e8ab10f80046c5785b5105aa1e6c8a72f6a8e629e5` |
| `assets/screenshots/03-live-mcp-status.png` | `1c38c1b86cb571966d328a62d002d8610d7b62e9a1d4cc8970b526962779616d` |
| `assets/screenshots/04-authenticated-operator-record.png` | `7eea0a122a39e7d2e160b997e3385a08b067c987ca21ec77f815feeb354f7bf2` |
