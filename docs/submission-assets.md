...
All screenshots are 1440 × 900 PNGs captured from `https://o2mjeuvaik.execute-api.us-east-1.amazonaws.com`. Portrait-bearing screenshots 1, 2, and 4 were recaptured after facial-plane correction deployment [34950926307](https://github.com/Mzoratto/mandate/actions/runs/34950926307); screenshot 3 is unchanged because the simulator does not render the portrait.
...
| `assets/screenshots/01-public-guided-simulation.png` | `50bb5cff92516eb83ebdfef784321aafd4c36bddbd94d3edad0366d32addcc3f` |
| `assets/screenshots/02-boundary-denial.png` | `86b2b1d83fbfb2c440004e07eef09e992c79d4c684a19073dfdad5bad2b23932` |
| `assets/screenshots/03-live-mcp-status.png` | `1c38c1b86cb571966d328a62d002d8610d7b62e9a1d4cc8970b526962779616d` |
| `assets/screenshots/04-authenticated-operator-record.png` | `353d67e56a7cbdc5d518425cf95ad3556dbb411713c5bea4eb38cd566e34c681` |
